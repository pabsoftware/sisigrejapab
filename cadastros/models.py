...
class Congregacoes(UuidModel, Address, Active, TimeStampedModel):
    nome = models.CharField(max_length=200, help_text='Informe o nome da congregação')
    dirigente = models.CharField(max_length=200, help_text='Informe o nome do dirigente da congregação')
